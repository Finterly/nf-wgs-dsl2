...
require("knitr")
opts_knit$set(root.dir = "params$directory")
...
pf_stats <-read_tsv("Bam_stats_pf_Final.tsv", show_col_types = FALSE)
hs_stats <-read_tsv("Bam_stats_hs_Final.tsv", show_col_types = FALSE)
